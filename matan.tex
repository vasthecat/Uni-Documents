...
\begin{enumerate}
    ...
    $\bydef \exists \displaystyle\lim_{n \to \infty} x_n = x$
\end{enumerate}
\textbf{Теорема доказана.}
...
или $|x_n - a| < \varepsilon \bydef \exists \displaystyle\lim_{n \to \infty} x_n = a$.
...
\begin{enumerate}
    ...
    $\exists \displaystyle\lim_{n \to \infty} x_n = 
    \displaystyle\lim_{n \to \infty} \left( 1 + \frac{1}{n} \right)^{n + 1} = e$

    $\displaystyle\lim_{n \to \infty} \left( 1 - \frac{1}{n} \right)^{n}
    = \displaystyle\lim_{n \to \infty} \frac{x_n}{1 + \frac{1}{n}} = e \approx 2.71828$

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    \item Докажем, что $\displaystyle\lim_{n \to \infty} \frac{n^k}{a^n} = 0,
    \quad k \in \mathbb{N}, \quad a > 1$

    $\displaystyle\lim_{n \to \infty} \frac{n^k}{a^n} = 
    \displaystyle\lim_{n \to \infty} \left( \frac{n}{(\sqrt[k]{a})^n} \right)^k$
    ...
    $\displaystyle\lim_{n \to \infty} \frac{n}{(\sqrt[k]{a})^n} = 0
    \implies \displaystyle\lim_{n \to \infty} \frac{n^k}{a^n} = 0$
    ...
    * \frac{a}{k_0 + 1} * \dots *
    ...
    \displaystyle\lim_{n \to \infty} \beta_n = 0 \implies
