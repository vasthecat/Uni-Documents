...
\includeonly{
    ...
    sections/17-functional-sequences,
    sections/18-functional-series,
    sections/approximations,
    sections/fourier,
    sections/multiple-integral,
}
...
\include{sections/17-functional-sequences}
\include{sections/18-functional-series}
\include{sections/approximations}
\include{sections/fourier}
\include{sections/multiple-integral}
