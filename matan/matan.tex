...
\begin{theorem}[Признак Лейбница]
    Если для $\series{(-1)^k a_k} \; (a_k \geq 0)$ имеем $\{a_k\}$ монотонно невозрастает при $k \geq n_0$ и $\dslim_{k \to \infty} = 0 \implies \series{(-1)^k a_k}$ сходится.
\end{theorem}
\begin{proof}
    ...
    \[ S - S' = 0 \implies S = S' = sup\{S_{2n+1}\} = inf\{S_{2n}\} \implies \exists \dslimn S_n = sup\{S_{2n+1}\} = inf\{S_{2n}\} \implies \text{ряд расходится.} \]
\end{proof}
